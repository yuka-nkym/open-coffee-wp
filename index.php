...
<section id="lunch" class="lunch">
  <div class="lunch-inner">
    ...
    <div class="lunch-content">
      <p class="lunch-content-title">お好きなパスタをお選びください</p>
      <div class="lunch-cards">

        <div class="lunch-card">
          <figure class="lunch-card-img">
            <?php if (get_field('lunch_1', 300)['lunch1-image']) : ?>
              <img src="<?php echo $group_field = get_field('lunch_1', 300)['lunch1-image']; ?>" alt="hoge">
            <?php endif; ?>

          </figure>
          <div class="lunch-card-text">
            <p class="lunch-card-number">A</p>
            <?php if (get_field('lunch_1', 300)['lunch1-title']) : ?>
              <p class="lunch-card-title"><?php echo $group_field = get_field('lunch_1', 300)['lunch1-title']; ?></p>
            <?php endif; ?>
          </div>
        </div>
        <div class="lunch-card">
          <figure class="lunch-card-img">
            <?php if (get_field('lunch_2', 300)['lunch2-image']) : ?>
              <img src="<?php echo $group_field = get_field('lunch_2', 300)['lunch2-image']; ?>" alt="hoge">
            <?php endif; ?>
          </figure>
          <div class="lunch-card-text">
            <p class="lunch-card-number">B</p>
            <?php if (get_field('lunch_2', 300)['lunch2-title']) : ?>
              <p class="lunch-card-title"><?php echo $group_field = get_field('lunch_2', 300)['lunch2-title']; ?></p>
            <?php endif; ?>
          </div>
        </div>
        <div class="lunch-card">
          <figure class="lunch-card-img">
            <?php if (get_field('lunch_3', 300)['lunch3-image']) : ?>
              <img src="<?php echo $group_field = get_field('lunch_3', 300)['lunch3-image']; ?>" alt="hoge">
            <?php endif; ?>
          </figure>
          <div class="lunch-card-text">
            <p class="lunch-card-number">C</p>
            <?php if (get_field('lunch_3', 300)['lunch3-title']) : ?>
              <p class="lunch-card-title"><?php echo $group_field = get_field('lunch_3', 300)['lunch3-title']; ?></p>
            <?php endif; ?>
          </div>
        </div>
        <div class="lunch-card">
          <figure class="lunch-card-img">
            <?php if (get_field('lunch_4', 300)['lunch4-image']) : ?>
              <img src="<?php echo $group_field = get_field('lunch_4', 300)['lunch4-image']; ?>" alt="hoge">
            <?php endif; ?>
          </figure>
          <div class="lunch-card-text">
            <p class="lunch-card-number">D</p>
            <?php if (get_field('lunch_4', 300)['lunch4-title']) : ?>
              <p class="lunch-card-title"><?php echo $group_field = get_field('lunch_4', 300)['lunch4-title']; ?></p>
            <?php endif; ?>
          </div>
        </div>
...
<section id="grand-menu" class="grand-menu">
  <div class="grand-menu-inner inner">
    ...
    <div class="grand-menu-wrapper" <p class="grand-menu-category">パスタ</p>
...
<section id="gallery" class="gallery">
  <div class="inner">
    ...
    <div class="btn-link-box"><a href="https://www.instagram.com/oc_sample/" class="btn-link" target="_blank" rel="noopener noreferrer">インスタグラムを見る</a></div>
  </div>
</section>
<!-- /#gallery.gallery -->
  ...
  <div class="inner">
    <?php if (have_posts()) : while (have_posts()) : the_post();
        ...
        <?php endwhile;
          ...
          <div class="news-btn-link-box btn-link-box"><a href="<?php echo esc_url(home_url('/news/')); ?>" class="btn-link">過去のお知らせ</a></div>
  </div><!-- inner -->
</section>
<!-- /#news.news -->
